...
const totalElement = document.getElementById=('paragraph')

// Preparo il messaggio
const message = ('Il prezzo del biglietto è : €');

// Preparo il costo per km
...
/*--------------
 ...
 ---------------*/
  ...
  const kms = parseInt(prompt('Quanti chilometri deve percorrere?',100).trim())
  const age = parseInt(prompt('Quanti anni hai?', 27).trim())
  console.log('chilometri da percorrere', kms, 'età, utente', age)
